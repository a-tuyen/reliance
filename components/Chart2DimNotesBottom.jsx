...
const Chart2DimNotesBottom = ({
  ...
  return (
    <>
      ...
      <tr>
        <td colSpan={5} className="border-t-0 border-b-0">{note1}</td>
        </tr>
        <tr>
        <td colSpan={5} className="border-t-0 border-b-0">{note2}</td>
        </tr>
        <tr>
        <td colSpan={5} className="border-t-0 border-b-4">{note3}</td>
        </tr>
    </>
  );
};
