...
const Hero = ({ heading, message, tagline, img }) => {
  return (
    <div className="h-[100%] pb-0 mb-0">
      <div
        className={`relative items-center justify-center h-[100vh] mb-0 z-1 bg-fixed bg-center bg-cover ${img}`}
      ></div>
      {/* Overlay */}
      ...
      <div className="flex flex-col items-center text-white z-[1]">
        ...
        <p className="absolute justify-center w-[80%] max-w-6xl md:w-[70%] py-2 md:py-10 top-[60%] sm:top-[55%] font-heading text-2xl md:text-3xl text-white text-center font-thin z-[10]">
          {message}
        </p>
