...
znLb: '0.63 lb',
znKg: '(0.29 kg)',
alCode: 'AMAX PROP 63M UNIVERSAl',
alLb: '0.25 lb',
alKg: '(0.11 kg)',
diaIn: '2 3/8"',
diaMm: '(60 mm)',
...
note1: '- For 63mm Max Prop Hubs that use LARGE SCREWS (5mm diameter) on either 46mm (1 13/16") or 43mm (1 5/8") centers',
note2: '- Required for all model years 2006 and later ',
note3: '- Fits most other models except 2003, 2004 and 2005 that use SMALL SCREW SET',},

{znCode: 'MAX PROP 70M UNIVERSAL',
znLb: '0.88 lb',
znKg: '(0.4 kg)',
alCode: 'AMAX PROP 70M UNIVERSAL',
alLb: '0.34 lb',
alKg: '(0.15 kg)',
diaIn: '2 11/16"',
diaMm: '(68 mm)',
...
widMm: '30mm and 35mm',
note1: '- For 70mm Max Prop hubs that use either LARGE SCREWS (5mm) or SMALL (4mm) diameter mounting screws',
note2: '- Mounting holes 20mm (2") C/C',
note3: '- Uses the 63mm-70mm LARGE SCREW SET (5mm diameter socket cap screws, 20mm long, 4mm Hex Wrench) or the 63mm-70mm SMALL SCREW SET (4mm diameter socket cap screws, 20mm long, 3mm hex wrench)',},

{znCode: 'MAX PROP 83M UNIVERSAL',
znLb: '1.88 lb',
znKg: '(0.85 kg)',
alCode: 'AMAX PROP 83M UNIVERSAL',
alLb: '0.73 lb',
alKg: '(0.33 kg)',
diaIn: '3 1/8"',
diaMm: '(79 mm)',
...
note2: '- Small mounting holes: 55mm (2 1/8") C/C, Large Mounting holes: 60mm (2 3/8") C/C',
note3: '- For 2004 and newer propellers, use smaller mounting holes with SMALL SCREW SET (5mm diameter screws, 25mm long). For 2003 and older propellers, use larger mounting holes with LARGE SCREW SET (6mm diameter screws, 25mm long',},
